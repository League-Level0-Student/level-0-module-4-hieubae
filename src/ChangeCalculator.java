...
double wallet = (nick * 0.05) + (dime * 0.10) + (quart * 0.25);
		// Tell the user how much money they have
JOptionPane.showMessageDialog(null, "You have " + nick + " nickels, " + dime + " dimes, and " + quart + " quarters." + "\n" + "Your total is $" + wallet);
	}
}
